...
## <a name="management-apipythonapioverviewazureiotmanagement"></a>[관리 API](/python/api/overview/azure/iot/management)
...
## <a name="create-an-iothub"></a>IoT Hub 만들기
```python
...
> [관리 API 탐색](/python/api/overview/azure/iot/management)